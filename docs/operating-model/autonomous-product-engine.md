...
reviewt, als Draft-PR gegen `main` erstellt und bei vorhandener Vercel-Preview fachlich geprueft. Andreas
erhaelt danach eine kurze Entscheidungskarte mit Status, Nutzen, Preview, Tests, Risiken und Empfehlung.
